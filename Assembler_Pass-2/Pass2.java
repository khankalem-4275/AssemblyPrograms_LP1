	...
	public static void main(String args[])
  	{
		...
		System.out.println("-------------------------------");
		n=f.ProgramMatrix(Intermediate,4,"Intermediate.txt");// program_matrix returns an integer...
		...
		f.Display(MachineCode,m,4); // 'm' here basically displays the number of rows...
		System.out.println("===============================");
