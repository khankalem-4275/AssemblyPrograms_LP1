...
public class macroPass2 {
    public static void main(String[] Args) throws IOException {
        ...
        HashMap<Integer, String> aptab = new HashMap<Integer, String>(); // actual-parameter table
        HashMap<String, Integer> aptabInverse = new HashMap<String, Integer>(); // actual-parameter table inverse
        ...
        Vector<String> mdt = new Vector<String>(); // macro-definition-table-vector
        Vector<String> kpdt = new Vector<String>(); // keyword-parameter-default-table-vector
        String s, s1;
        int i, pp, kp, kpdtp, mdtp, paramNo; // number of positional & keyword parameters,kpdtp,mdtp,parameter_number
        ...
        while ((s = b1.readLine()) != null) {
            String b1Split[] = s.split("\\s"); // splitting by space character...
            if (macroNameHash.containsKey(b1Split[0])) {
                ...
                paramNo = 1; // setting the parameter number to --> 1 ....
                for (int j = 0; j < pp; j++) {
                ...
                i = mdtp - 1;
                while (mdt.get(i).compareToIgnoreCase("MEND") != 0) { // if MEND is not encountered.
                    f1.write("+ ");
